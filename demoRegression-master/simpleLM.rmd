...
Informally, this model seems to be a better model than the first model comparing HEAD and LENGTH. This model seems better becouse the residual standard error is
smaller and the adjusted R-square is explaining more of error than the other model.
